...
# input data paths
ctd_path = '/media/laserglaciers/upernavik/iceberg_py/dev/thermal_forcing_calculations/csv/avg_temp_sal.csv'
...
for berg_file in gdf_list:
    ...
    for u_rel, constant_tf in u_rel_tf_zip:
        ...
        factor = 1.3 # 4 is from Jackson et al 2020 to increase transfer coeffs
        ...
        # out_file = f'{op_berg_model}{date_str}_urel{u_rel}_fiamma_ctd_bergs_coeff{factor}.pkl'
        ...
        op_berg_model = f'/media/laserglaciers/upernavik/iceberg_py/dev/outfiles/helheim/berg_model_fiamma_ctd/factor_{factor}/'
        ...
        op = f'/media/laserglaciers/upernavik/iceberg_py/dev/outfiles/helheim/Qib_melt_flux_fiamma_ctd/coeff_{factor}_urel05_test/'
        if not os.path.exists(op):
            os.makedirs(op)
        
        Q_ib_ds.to_netcdf(f'{op}{date_str}_hel_coeff_{factor}_CTD_constant_UREL_{u_rel}.nc')
