...
# input data paths
ctd_path = '/media/laserglaciers/upernavik/iceberg_py/dev/infiles/ctdSFjord.mat'
...
for berg_file in gdf_list:
    ...
    op_berg_model = '/media/laserglaciers/upernavik/iceberg_py/dev/outfiles/helheim/berg_model/'
    ...
    for u_rel, constant_tf in u_rel_tf_zip:
        ...
        op = f'/media/laserglaciers/upernavik/iceberg_py/dev/outfiles/helheim/Qib_melt_flux_only_aw_test/coeff_{factor}_urel05_test/'
